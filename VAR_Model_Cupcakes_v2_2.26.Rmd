...
# Forecasting ARIMA
forecast.cupcakes.sales.arima_2015 <- forecast(cupcakes_train_sales_arima_model, h=104)
forecast.cupcakes.sales.arima_2015$mean
# Plot
plot(forecast(object=forecast.cupcakes.sales.arima_2015,h="104"))
...
# Append ARIMA sales data and forecasts 
cupcakes.sales.arima.2015 <- append(cupcakes_train_sales_data_arima, forecast.cupcakes.sales.arima_2015$mean)

length(cupcakes.sales.arima.2015)

# Append VAR data and forecasts 
cupcakes.sales.VAR.2015 <- append(Train_cupcakes_sales, var_cupcakes_forecasts_2015$fcst$Train_cupcakes_sales[,1])

# Create a dataframe VAR Forecasts, ARIMA Forecasts

cupcakes_df_total_final_2015 <- cbind.data.frame(cupcakes.week.All, cupcakes.sales.VAR.2015, cupcakes.sales.arima.2015)


mar.default <- c(3,3,3,3) + 0.1
par(mar = mar.default + c(0, 1, 0, 0))
plot(cupcakes_df_total_final_2015[,1:2], type="l", 
     ylab="", xlab="Time (Year)",
     lwd=3, main="cupcakes Sales Volume Forecasts Comparison", col="hotpink")
par(new=TRUE)
# Actual data train + test
plot(cupcakes_df_total_final_2015[,3], type="l", col="darkolivegreen1", axes=FALSE, 
     ylab="", xlab="", lwd=3)
par(new=TRUE)
# ARIMA Forecast 
plot(cupcakes_df_total_final[,4], type="l", col="blue", axes=FALSE, 
...
VAR Model for 2015 Predictions 
